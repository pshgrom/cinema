...
import { fetchMovieSessions } from '../api/movies'
...
onMounted(async () => {
  ...
  loading.value = true
  try {
    sessions.value = await fetchMovieSessions(id)
  } catch (e) {
...
<template>
  <div class="details">
    <h1 class="details__title">🎬 Сеансы фильма</h1>
    ...
    <div v-else class="details__sessions">
      ...
      >
        <div class="session-card__info">
          <div class="session-card__cinema">🎭 Кинотеатр #{{ s.cinemaId }}</div>
